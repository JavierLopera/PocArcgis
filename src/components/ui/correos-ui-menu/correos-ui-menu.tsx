...
@Component({
	tag: 'correos-ui-menu',
	styleUrl: 'correos-ui-menu.scss',
	shadow: true
})

export class CorreosUiMenu {
	/*	
		CONSIDERACIONES:
	...
	*/
	...
	actionEventListener = (ev: CustomEvent) => {
		...
		this.elementClicked(this.optionsFiltered[selectedIndex])
	};
	...
	render() {
		...
		this.menuOptionsMDCElement = (
			<div class="mdc-menu mdc-menu-surface" ref={el => this.menuOptionsMDCElement = el as HTMLInputElement}>
				{list}
			</div >
		);
