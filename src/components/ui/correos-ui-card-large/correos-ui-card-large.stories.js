...
const dummyImage =  /*html*/`
	<svg slot="image" width="159px" height="97px" viewBox="0 0 159 97" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
export const verticalCard = () => {
	...
	el.innerHTML = /*html*/`
		<div class="storybook-container">
			...
			>
				...
				<h3 slot="title" class="text-headline-1 text-light text-color-tint"> ${slotCardTitle.title}</h3>
				<p slot="body-text" class="text-color-main text-light" > ${slotCardTitle.mainText }</p>
				<footer slot="footer">
					<correos-ui-button slot="footer" link secondary>
						<span slot="text">${slot.text}</span>
						<i slot="icon-right" class="ico_notif_info"></i>
					</correos-ui-button>
				</footer>
	...
	const $wcUiButton = el.querySelector('correos-ui-card-large');
